...
class ChestXray_Dataset(Dataset):
    ...
    def __init__(self, path='./data/chestxray14', mode='RGB', adjgroup=True, neib_samp='relation', \
...
class Chexpert_Dataset(Dataset):
    ...
    def __init__(self, path='./data/chexpert', mode='RGB', adjgroup=True, neib_samp='relation', \
                 relations= ['pid', 'age', 'gender', 'view'], k = 16, graph_nodes='current',  transform=None):
        self.path=path
...
class MimicCXR_Dataset(Dataset):
    ...
    def __init__(self, path='./data/mimic_cxr', mode='RGB', adjgroup=True, neib_samp='relation', \
