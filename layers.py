...
class DEDICOMDecoder(nn.Module):
    """DEDICOM Tensor Factorization Decoder model layer for link prediction.    ""用于链路预测的DEDICOM张量分解解码器模型层。"""""
...
class DistMultDecoder(nn.Module):
    """DistMult Decoder model layer for link prediction.用于链路预测的干扰解码器模型层。"""
...
class BilinearDecoder(nn.Module):
    """Bilinear Decoder model layer for link prediction.用于链路预测的双线性解码器模型层"""
    def __init__(self, input_dim, num_types, issymmetric=True, bias=True, act=lambda x:x):
...
class LinearDecoder(nn.Module):
    """Linear Decoder model layer for link prediction.用于链路预测的线性解码器模型层"""
    def __init__(self, input_dim, num_types, issymmetric=True, bias=True, act=lambda x:x):
...
class MLPDecoder(nn.Module):
    """multi-layer perceptron Decoder model layer for link prediction.用于链路预测的多层感知器解码器模型层。"""
...
class InnerProductDecoder(nn.Module):
    """Decoder model layer for link prediction.用于链路预测的解码器模型层。"""
